...
import { data } from "./data/revenuechartdata"
    ...
    <div className='bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl rounded-b-2xl border border-slate-200/50 dark:border-slate-700/50 p-6'>
        ...
        <div className='h-80'>
            <ResponsiveContainer width="100%" height="100%">
                <BarChart data={data} margin={{ top: 20, right: 30, left: 20, botton: 5}}>
                    <CartesianGrid strokeDasharray="3.3" stroke="#e2e8f0" opacity={0.3} />
                    <XAxis dataKey="month" stroke="#64748b" fontsize={12} tickLine={false} axisLine={false} />
                    <YAxis stroke="#64748b" fontsize={12} tickLine={false} axisLine={false} tickFormatter={(value) => `$${value / 1000}k`} />
                    <Tooltip contentStyle={{backgroundColor : "rgba(255, 255, 255, 0.95)", border: "none", borderRadius: "12px", boxShadow: "0 10px 40px rgba(0, 0, 0, 0.1"}} formatter={(value) => [`$${value.toLocaleString()}`, ""]}/>

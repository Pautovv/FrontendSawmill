                ...
                <div className='flex items-start justify-between'>
                    <div className='flex-1'>
                        ...
                        <div className='flex items-center space-x-2'>
                            ...
                            <span className='text-sm text-slate-500 dark:text-slate-400'>vs последнее</span>
                        </div>
                    </div>
                <div className={`p-3 rounded-xl ${stats.bgColor} group-hover:scale-110 transition-all duration-300`}>{<stats.icon className={`w-6 h-6 ${stats.textColor}`} />}</div>
                </div>
                {/* Progressbar */}
